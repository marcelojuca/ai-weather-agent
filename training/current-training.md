...
- ✅ [Lesson 1.1: What is TDD?](#lesson-1-1-what-is-tdd)
- ✅ [Lesson 1.2: What is an AI Agent?](#lesson-1-2-what-is-an-ai-agent)
- ✅ [Lesson 1.3: What is LangGraph?](#lesson-1-3-what-is-langgraph)
- ✅ [Lesson 1.4: What is Scenario Testing?](#lesson-1-4-what-is-scenario-testing)
- ✅ [Lesson 1.5: The Development Tools](#lesson-1-5-the-development-tools)
- ✅ [Lesson 1.6: How It All Works Together](#lesson-1-6-how-it-all-works-together)
- ✅ [Lesson 1.7: Your Project Structure](#lesson-1-7-your-project-structure)
- ✅ [Understanding Check 1.1 - PASSED](#understanding-check-11---passed-)

### Module 2: Hands-On with Development Tools ✅ COMPLETED
- ✅ [Lesson 2.1: ruff Hands-On (Part 1 - Finding Issues)](#lesson-2-1-ruff-finding-issues)
- ✅ [Lesson 2.2: ruff Hands-On (Part 2 - Fixing Automatically)](#lesson-2-2-ruff-fixing-issues)
- ✅ [Lesson 2.3: ruff Configuration](#lesson-2-3-ruff-configuration)
- ✅ [Lesson 2.4: pre-commit Hands-On (Part 1 - Installation)](#lesson-2-4-pre-commit-understanding)
- ✅ [Lesson 2.5: pre-commit Hands-On (Part 2 - Setting Up)](#lesson-2-5-pre-commit-setup)
- ✅ [Lesson 2.6: pre-commit Configuration (Part 3 - Understanding the Config)](#lesson-2-6-pre-commit-configuration)
- ✅ [Lesson 2.7: pytest-watch Understanding](#lesson-2-7-pytest-watch-understanding)
- ✅ [Lesson 2.8: pytest-watch Hands-On (Part 1 - Getting Started)](#lesson-2-8-pytest-watch-hands-on)
- ✅ [Lesson 2.9: The Complete TDD Cycle with pytest-watch](#lesson-2-9-the-tdd-cycle-with-pytest-watch)
- ✅ [Lesson 2.10: Putting It All Together](#lesson-2-10-integrating-all-tools)

### Module 3: Deep Dive into LangGraph 🔄 IN PROGRESS
- 🔄 [Lesson 3.1: StateGraph Concept](#lesson-3-1-stategraph-concept) ← YOU ARE HERE
- ⏳ [Lesson 3.2: Nodes](#lesson-3-2-nodes) (coming next)
- ⏳ [Lesson 3.3: Edges and Routing](#lesson-3-3-edges-and-routing)
- ⏳ [Lesson 3.4: The Complete Graph](#lesson-3-4-the-complete-graph)
- ⏳ [Lesson 3.5: Weather Agent Structure](#lesson-3-5-weather-agent-structure)
- ⏳ [Lesson 3.6: MessagesState Deep Dive](#lesson-3-6-messagesstate-deep-dive)
- ⏳ [Lesson 3.7: Tool Calling](#lesson-3-7-tool-calling)
- ⏳ [Lesson 3.8: The Agent Loop](#lesson-3-8-the-agent-loop)
...
Each time you return, this file shows:
1. **Where you are** - Your current lesson location
2. **What you've completed** - Marked with ✅
3. **What's next** - Your next lesson ready to start
4. **Your understanding checks** - With your answers and feedback
...
[↑ Back to Quick Jump Navigation](#quick-jump-navigation)
